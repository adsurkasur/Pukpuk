...
export default function RootLayout({ children }: { children: ReactNode }) {
  return (
    <html lang="en">
      <head>
        <title>Pukpuk - Agricultural Demand Forecasting Platform</title>
        ...
        <meta name="author" content="Pukpuk" />
        <meta property="og:title" content="Pukpuk - Agricultural Demand Forecasting" />
